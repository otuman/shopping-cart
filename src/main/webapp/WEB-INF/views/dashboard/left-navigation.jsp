      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<c:url value='/dashboard/'></c:url>"><i class="fa fa-circle-o"></i> Home - Dashboard</a></li>
            <li><a href="<c:url value='/'></c:url>"><i class="fa fa-circle-o"></i> Home - Front</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
