    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="f" id="product-category-create-form" action="<c:url value='/dashboard/products/categories/create?${_csrf.parameterName}=${_csrf.token}'></c:url>" method="POST" enctype="multipart/form-data">
		          <div class="row">
		             <div class="col-md-6">	                    
